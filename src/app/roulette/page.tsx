        ...
        {phase === "betting" && (
          <>
            ...
            <div style={{
              ...
              <span style={{ fontSize: "0.65rem", fontFamily: "'Barlow Condensed', sans-serif", letterSpacing: "0.14em", color: "var(--text-muted)", textTransform: "uppercase" }}>Bet</span>
              <span style={{ fontFamily: "'Barlow Condensed', sans-serif", fontWeight: 700, fontSize: "1.05rem", color: "var(--text-primary)", flex: 1 }}>${betAmount.toFixed(2)}</span>
              {betAmount > 0 && (
