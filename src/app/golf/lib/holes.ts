...
export const HOLES: HoleConfig[] = [
  ...
  },
  {
    ...
    walls: [...baseWalls(), { from: { x: 220, y: 110 }, to: { x: 220, y: 430 } }, { from: { x: 430, y: 110 }, to: { x: 430, y: 430 } }, { from: { x: 640, y: 110 }, to: { x: 640, y: 430 } }, { from: { x: 220, y: 110 }, to: { x: 640, y: 110 } }, { from: { x: 220, y: 430 }, to: { x: 640, y: 430 } }],
    obstacles: [{ id: "f1", type: "rect", x: 500, y: 230, w: 90, h: 80 }],
    surfaces: [{ id: "f", kind: "fairway", x: 30, y: 30, w: 900, h: 480, friction: 0.95 }, { id: "lava", kind: "lava", x: 300, y: 210, w: 290, h: 120, friction: 0.86 }],
    hammers: [
      { id: "h9a", pivot: { x: 325, y: 270 }, armLength: 95, angleMin: -1.4, angleMax: 1.4, speed: 2.5, headRadius: 20 },
      { id: "h9b", pivot: { x: 545, y: 270 }, armLength: 95, angleMin: 1.7, angleMax: 4.6, speed: 2.2, headRadius: 20 },
    ],
  },
];
